...
enum Images {
    static let githubLogo = UIImage(systemName: "gh-logo")
    static let githubAvatar = UIImage(systemName: "avatar-placeholder")
    static let emptyLogo = UIImage(systemName: "empty-state-logo")
}
